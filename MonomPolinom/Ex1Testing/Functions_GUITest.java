...
//	}
	...
	void testDrawFunctionsIntIntRangeRangeInt() {
		String s = System.getProperty("user.dir") + "\\GUI_params.json";
		_data.drawFunctions(s);
		/*Polynom po1 = new Polynom("x^2");
		Polynom po2 = new Polynom("x^4");
		Polynom po3 = new Polynom("6");
		Polynom po4 = new Polynom("8");
